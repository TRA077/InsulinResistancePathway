...
This repository contains the MATLAB code and graphs for modeling the insulin resistance pathway in the liver. The model simulates the dynamics of glucose uptake by the liver in response to insulin, and it can be used to investigate the effects of insulin resistance on glucose metabolism.<br>
**Motivation:-** Our pursuit of this research project was fueled by the imperative to address the escalating global impact of diabetes, being the sixth leading cause of death worldwide. With millions affected, the strain on healthcare systems, compromised quality of life, and soaring expenditures underscore the urgency for intervention. Diabetes, comprising both Type 1 and Type 2, poses a formidable challenge. The elusive origins of Type 1 diabetes and the intricacies of Type 2, characterized by insulin resistance, demand a comprehensive understanding. Coupled with the rising healthcare costs for insulin-dependent patients, our research aims to unravel the molecular nuances of the disease, accentuating the need for preventative strategies. The evolving landscape of disease discovery, condensing from a decade to 2-3 years, further emphasizes the timeliness of our efforts. The unintended consequences of medications, increasing blood viscosity and leading to blockages, raise further concerns. Exploring the ripple effects of insulin changes on the occurrence of Non-Communicable Diseases (NCDs) and lifestyle disorders completes our rationale. By delving into these complex facets, our project aspires not only to enhance understanding but to pave the way for effective prevention and treatment strategies, alleviating the profound impact of diabetes on global health.<br>
**Framework Used-** **MATLAB**
## Installation
To use this project you need to install MATLAB R2023b with all the required products helping it like mathematical modelling, coding ,and simulation tools,etc. Link for installation:- https://in.mathworks.com/downloads/
Or you could just run this online at:- https://matlab.mathworks.com/
# Project info.:-
...
# Summary
Our project aimed to understand the complex mechanisms of insulin resistance in the liver. By building a computational model using MATLAB, we were able to simulate the flow of glucose and insulin through the liver's metabolic pathways. Our analysis revealed that insulin resistance significantly reduces the uptake of glucose by the liver, leading to hyperglycemia. Additionally, we discovered that the liver compensates for this reduced uptake by increasing its own production of glucose, further contributing to the problem. By investigating the model's sensitivity to different parameters, we identified key factors that play a crucial role in insulin resistance. Moreover, the model's predictive power allowed us to simulate the response of the pathway to various interventions, such as changes in diet or medications. This opens doors to personalized medicine, drug discovery, and public health education, paving the way for a brighter future for individuals struggling with insulin resistance. While our model is a simplified representation of the complex biological system, it provides valuable insights into the mechanisms underlying insulin resistance and its potential treatment strategies.
